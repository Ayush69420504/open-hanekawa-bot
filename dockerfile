...
RUN apk update
RUN apk add --no-cache libffi libffi-dev gcc musl-dev linux-headers opus opus-dev opus-tools
...
COPY --from=mwader/static-ffmpeg:latest-arm64 /ffmpeg bin/ffmpeg
